...
RSpec.describe 'Road Trip Request specs' do
  describe 'POST /api/v1/road_trip' do
    ...
    it 'if all params are present it returns all the needed information for the road trip', :vcr do
      ...
      expect(road_trip[:data][:attributes][:travel_time]).to_not eq 'impossible route'
    ...
    it 'returns an error if api_key is incorrect', :vcr do
      process :post, '/api/v1/road_trip', params: {
        origin: "Denver, CO",
        destination: "Estes Park, CO",
        api_key: '1234'
